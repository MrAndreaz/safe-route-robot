...
// Новый: атомарная отправка сразу двух моторов одной командой
...
void setup() {
  ...
  server.on("/motorpair", handleMotorPair); // новый, атомарный
